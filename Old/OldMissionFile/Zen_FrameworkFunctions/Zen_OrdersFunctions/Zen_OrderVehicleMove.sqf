...
_vehicleGrp setCurrentWaypoint (_vehicleGrp addWaypoint [_inPos, -1]);
_vehicleGrp move _inPos;
...
(group _vehicleDriver) setCurrentWaypoint ((group _vehicleDriver) addWaypoint [(getPosATL _vehicle), -1]);
(group _vehicleDriver) move (getPosATL _vehicle);
(_vehicleDriver) doMove (getPosATL _vehicle);

_vehicleDriver enableAI "Move";
_vehicleDriver enableAI "FSM";
_vehicleDriver enableAI "Target";
_vehicleDriver enableAI "AutoTarget";
_vehicleDriver enableAI "SUPPRESSION";
_vehicleDriver enableAI "COVER";
_vehicleDriver enableAI "AUTOCOMBAT";
_vehicleDriver enableAI "AIMINGERROR";
