...
switch (toLower _objType) do {
    ...
    case "convoy": {
        ...
        {
            0 = [_x, _objPos, _convoySpeed] spawn Zen_OrderVehicleMove;
        } forEach _objects;
...
switch (toLower _triggerType) do {
    ...
    case "rescue": {
        0 = [_objects, (_this select 1), _taskUniqueName] spawn Zen_TriggerAreRescued;
    };
    case "reach": {
        0 = [(_this select 1), _taskUniqueName, "succeeded", _objects] spawn Zen_TriggerAreNear;
    };
    default {
